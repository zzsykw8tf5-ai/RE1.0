  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="card">
          <h3 className="font-semibold text-apple-text mb-4 flex items-center gap-2"><DollarSign size={15} className="text-apple-blue" />Sales Comparison Approach</h3>
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-apple text-xs text-blue-700">
        <strong>FX Note:</strong> Werte in USD werden mit einem Wechselkurs von 1 EUR = 1,08 USD umgerechnet. Die Bewertung erfolgt gemäß den Uniform Standards of Professional Appraisal Practice (USPAP).
      </div>
    </div>
  );
}
